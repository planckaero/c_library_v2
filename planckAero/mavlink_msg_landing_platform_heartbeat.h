...
#define MAVLINK_MSG_ID_LANDING_PLATFORM_HEARTBEAT 993
...
#define MAVLINK_MSG_ID_993_LEN 8
#define MAVLINK_MSG_ID_993_MIN_LEN 8

#define MAVLINK_MSG_ID_LANDING_PLATFORM_HEARTBEAT_CRC 82
#define MAVLINK_MSG_ID_993_CRC 82
